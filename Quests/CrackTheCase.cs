...
// Type: BobsBuddy.Quests.CrackTheCase
...
public class CrackTheCase(QuestData data, Simulator simulator, bool controlledByPlayer) : 
  Quest(data, simulator, controlledByPlayer),
  IOnFriendlyMinionIsAttacking,
  IEntity
{
  public const string CardId = "BG24_Quest_352";
