...
// Type: BobsBuddy.Minions.Dragon.TwilightWhelp
...
public class TwilightWhelp(string cardId, bool controlledByPlayer, Simulator simulator) : 
  Minion(cardId, controlledByPlayer, simulator),
  IOnSummoned,
  IEntity
{
  public const string CardId = "BG34_630t";
  ...
  public Action? OnSummoned()
  {
    return (Action) (() =>
    {
      ...
      if (this.Simulator.state.TriggerScope.Current.Name == "WhelpWatcher")
        this.Simulator.AttackWithMinion((Minion) this, this.Simulator.CurrentAttackTarget);
      else
