...
// Type: BobsBuddy.Minions.Dragon.TimewarpedVaelastrasz
...
public class TimewarpedVaelastrasz(string cardId, bool controlledByPlayer, Simulator simulator) : 
  Minion(cardId, controlledByPlayer, simulator),
  IOnRally,
  IEntity
{
  public const string CardId = "BG34_Giant_585";
