...
// Type: BobsBuddy.Minions.Beast.Devilsaur
...
public class Devilsaur(string cardId, bool controlledByPlayer, Simulator simulator) : 
  Minion(cardId, controlledByPlayer, simulator),
  IOnSummoned,
  IEntity
{
  public const string CardId = "BG22_001t2";
