...
// Type: BobsBuddy.Minions.Beast.TimewarpedTamuzo
...
public class TimewarpedTamuzo(string cardId, bool controlledByPlayer, Simulator simulator) : 
  Minion(cardId, controlledByPlayer, simulator),
  IOnAfterFriendlyMinionSummoned,
  IEntity
{
  public const string CardId = "BG34_Giant_595";
