...
// Type: BobsBuddy.Minions.Buddy.Kilrek
...
public class Kilrek(string cardId, bool controlledByPlayer, Simulator simulator) : 
  Minion(cardId, controlledByPlayer, simulator),
  IDeathrattle,
  IEntity
{
  public const string CardId = "TB_BaconShop_HERO_37_Buddy";
  ...
  public Action<Minion> GetDeathrattle() => Kilrek.Deathrattle(this.golden);
