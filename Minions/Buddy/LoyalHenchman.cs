...
// Type: BobsBuddy.Minions.Buddy.LoyalHenchman
...
public class LoyalHenchman(string cardId, bool controlledByPlayer, Simulator simulator) : 
  Minion(cardId, controlledByPlayer, simulator),
  IOnFriendlyMinionKilledEnemy,
  IEntity
{
  public const string CardId = "TB_BaconShop_HERO_45_Buddy";
