...
// Type: BobsBuddy.Minions.Mech.TimewarpedImmortal
...
public class TimewarpedImmortal(string cardId, bool controlledByPlayer, Simulator simulator) : 
  Minion(cardId, controlledByPlayer, simulator),
  IOnStartOfCombat,
  IEntity
{
  public const string CardId = "BG34_Giant_597";
