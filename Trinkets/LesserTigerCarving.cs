...
// Type: BobsBuddy.Trinkets.LesserTigerCarving
...
public class LesserTigerCarving(string cardId, Simulator simulator, bool controlledByPlayer) : 
  Trinket(cardId, simulator, controlledByPlayer),
  IOnFriendlyMinionTakeDamage,
  IEntity
{
  public const string CardId = "BG30_MagicItem_427";
