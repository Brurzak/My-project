...
// Type: BobsBuddy.Trinkets.GreaterBloodboundEarrings
...
public class GreaterBloodboundEarrings(string cardId, Simulator simulator, bool controlledByPlayer) : 
  Trinket(cardId, simulator, controlledByPlayer),
  IOnAfterAnySpellCast,
  IEntity
{
  public const string CardId = "BG32_MagicItem_808t";
