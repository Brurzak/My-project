...
// Type: BobsBuddy.Trinkets.GreaterTwinSkyLanterns
...
public class GreaterTwinSkyLanterns(string cardId, Simulator simulator, bool controlledByPlayer) : 
  ...
  IOnAfterAttackStep
{
  public const string CardId = "BG30_MagicItem_822t2";
  ...
  {
    if (this.FriendlySide.Count >= 6 || this._summon == null || this._summoned)
      return;
    this.Simulator.TrySummonMinions((IEnumerable<Summon>) new Summon[2]
    {
      this._summon,
      this._summon
