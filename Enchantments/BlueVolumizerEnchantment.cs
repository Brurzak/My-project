...
// Type: BobsBuddy.Enchantments.BlueVolumizerEnchantment
...
public class BlueVolumizerEnchantment(string cardId, Simulator simulator, bool controlledByPlayer) : 
  Enchantment(cardId, simulator, controlledByPlayer),
  IPassiveAttackBonus,
  IEntity,
  IPassiveHealthBonus
{
  public const string CardId = "BG34_170t2e";
