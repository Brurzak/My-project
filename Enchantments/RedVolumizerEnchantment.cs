...
// Type: BobsBuddy.Enchantments.RedVolumizerEnchantment
...
public class RedVolumizerEnchantment(string cardId, Simulator simulator, bool controlledByPlayer) : 
  Enchantment(cardId, simulator, controlledByPlayer),
  IPassiveAttackBonus,
  IEntity,
  IPassiveHealthBonus
{
  public const string CardId = "BG34_170te";
