...
// Type: BobsBuddy.HeroPowers.TavishAimHighHeroPower
...
public class TavishAimHighHeroPower(
  string cardId,
  Simulator simulator,
  ...
  public Action? OnStartOfCombat()
  {
    return (Action) (() =>
    {
      ...
      if (highestHealthMinion == null)
        return;
      this.Simulator.ProcessDamage(this.Data.Data2, highestHealthMinion, (Entity) this);
    });
  }
}
