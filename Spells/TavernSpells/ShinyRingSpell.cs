...
// Type: BobsBuddy.Spells.TavernSpells.ShinyRingSpell
...
public class ShinyRingSpell : ITavernSpell
{
  public const string CardId = "BG28_168";
  public const string Text = "Give your minions +{0}/+{1}.";
  ...
  public void Cast(Entity source, Simulator simulator, Minion? _)
  {
    ...
    foreach (Minion minion in source.FriendlySide.Where<Minion>((Func<Minion, bool>) (x => x.IsAlive())))
      minion.IncreaseStats(1 + tavernSpellAtkBuff, 1 + tavernSpellHealthBuff, source);
  }
}
