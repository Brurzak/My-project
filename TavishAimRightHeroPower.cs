...
// Type: BobsBuddy.HeroPowers.TavishAimRightHeroPower
...
public class TavishAimRightHeroPower(
  string cardId,
  Simulator simulator,
  ...
  public Action? OnStartOfCombat()
  {
    return (Action) (() =>
    {
      if (this.OpposingSide.Count == 0)
        return;
      this.Simulator.ProcessDamage(this.Data.Data2, this.OpposingSide.Last<Minion>(), (Entity) this);
    });
  }
}
